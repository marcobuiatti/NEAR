...
1) Use EEGLAB GUI (File - Manage EEGLAB Extensions - Search for NEAR - Install/Update). NOTE: not available yet (NEAR will be publicly linked to EEGLAB once the associated article will be published) <br />
